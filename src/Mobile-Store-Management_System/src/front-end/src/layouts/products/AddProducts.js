      ...
      <div class="form-out">
        ...
        <form onSubmit={sendData}>
          <div className="row g-3 ">
            ...
            {/* weight     */}
            <div className="col-md-6">
              <label for="product_weight" className="form-label">
                Product weight
              </label>
            ...
            {/* price */}
            <div className="col-md-6">
              <label for="product_price1" className="form-label">
                Product Price{' '}
              </label>{' '}
              <br></br>
              ...
              <input
                ...
                className="form-control"
                id="product_price1"
                placeholder="enter Product price 1.."
                onChange={(e) => {
            ...
            {/* discription     */}
            <div className="col-md-6">
              <label class="form-check-label" for="productDescriptionTextArea">
                Product Description
              </label>{' '}
              <br></br>
            ...
            <div className="col-md-6">
              <label for="productImage" className="form-label">
                Product Image <span className="warning-additional">(1600px * 900px)</span>
              </label>
              <br></br>
              <br></br>
              {error && imgUrl.length <= 0 ? <label className="form-error">*Product image didn't uploaded</label> : ''}
              ...
              {!imgUrl && (
                <div className="outerbar">
                  <div className="innerbar" style={{ width: `${progresspercent}%`, color: 'red' }}>
                    {progresspercent}%
                  </div>
                </div>
              )}
              {imgUrl && <img src={imgUrl} alt="uploaded file" height={50} />}
            </div>
